/****************************************************************************
** Meta object code from reading C++ file 'baslercamera.h'
**
...
#error "The header file 'baslercamera.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 15), // "sigCurrentImage"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 4) // "qImg"

    },
    "BaslerCamera\0sigCurrentImage\0\0qImg"
};
...
void BaslerCamera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigCurrentImage((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaslerCamera::sigCurrentImage)) {
                *result = 0;
                return;
            }
        }
...
void *BaslerCamera::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Pylon::CImageEventHandler"))
        return static_cast< Pylon::CImageEventHandler*>(this);
...
// SIGNAL 0
void BaslerCamera::sigCurrentImage(QImage _t1)
{
